...
-- Træ & Tagplader
(1, 'Brædt 360', '25x200 mm trykimp. understernbrædder til for & bag ende', 'stk', 360, 2.5, 20, 151.00),
(1, 'Brædt 540', '25x200 mm trykimp. understernbrædder til siderne', 'stk', 540, 2.5, 20, 225.00),
(1, 'Overstern 360', '25x125 mm trykimp. oversternbrædder til forenden', 'stk', 360, 2.5, 12.5, 95.00),
(1, 'Overstern 540', '25x125 mm trykimp. oversternbrædder til siderne', 'stk', 540, 2.5, 12.5, 135.00),
...
(1, 'Vandbrædt 360', '19x100 mm trykimp. på stern i forende', 'stk', 360, 1.9, 10, 50.00),
...
-- Beslag & Skruer
(2, 'Bundskruer', 'Plastmo, 3 pakke, til tagplader', 'pakke', 200, NULL, NULL, 120.00),
(2, 'Hulbånd | 20mm', '10 mtr., 2 rulle, til vindkryds på spær', 'rulle', 1000, 20, NULL, 45.00),
(2, 'Universal skruer | 190mm', '15 stk til montering af spær på rem', 'stk', 190, NULL, NULL, 12.00),
(2, 'Universal skruer | 190mm', '15 stk til montering af spær på rem', 'stk', 190, NULL, NULL, 12.00),
(2, 'Skruer | 200stk', '1 pakke til montering af stern & vandbrædt', 'pakke', 60, 4.5, NULL, 75.00),
(2, 'Beslagskruer | 250stk', '3 pakke til montering af universalbeslag + hulbånd', 'pakke', 50, 4, NULL, 80.00),
(2, 'Bræddebolt', '18 stk til montering af rem på stolper', 'stk', 120, 10, NULL, 25.00),
(2, 'Firkantskiver', '12 stk til montering af rem på stolper', 'stk', 40, 40, 11, 8.00),
(2, 'Skruer | 400stk', '2 pakke til montering af yderste beklædning', 'pakke', 70, 4.5, NULL, 95.00),
(2, 'Skruer | 300stk', '2 pakke til montering af inderste beklædning', 'pakke', 50, 4.5, NULL, 75.00),
(2, 'Stalddørsgreb', '1 sæt til lås på dør i skur', 'sæt', 50, 75, NULL, 150.00),
(2, 'Hængsel', '2 stk til skurdør', 'stk', 390, NULL, NULL, 65.00),
(2, 'Vinkelbeslag', '32 stk til montering af løsholter i skur', 'stk', 35, NULL, NULL, 5.00);
